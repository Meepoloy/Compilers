...
weaver_intg errorNumber;				/* Run-time error number = 0 by default (ANSI) */

/* External objects */
extern weaver_intg line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
weaver_void printScannerError(weaver_string fmt, ...);
weaver_void displayScanner(BufferPointer ptrBuffer);
weaver_long getScannerFilesize(weaver_string fname);
...
weaver_intg mainScanner(weaver_intg argc, weaver_string* argv) {
